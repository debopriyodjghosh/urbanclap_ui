            ...
            <div style="input-group-prepend">
                ...
                <!--<select class="form-control"  readonly>
                    ...
                    <?php
                        ...
                        <label><input type="checkbox" class="common_selector ram" value="<?php echo $row['s_name']; ?>"  > <?php echo $row['s_name']; ?></label>
                    </div>
        ...
        <div class="form-group">
            ...
            <div style="input-group-prepend">
                ...
                <!--<select class="form-control" name="sp_city" readonly>
                    ...
                    <?php
                            foreach($edit_row as $row)                     {?>
                                <!--#echo "<option class='common_selector ram' value='" . $row['sp_city'] . "'>" . $row['sp_city'] . "</option>";        -->           
                                <div class="list-group-item checkbox">
                                <label><input type="checkbox" class="common_selector brand" value="<?php echo $row['sp_city']; ?>"  > <?php echo $row['sp_city']; ?></label>
                            </div>
                            <?php
                        }
                            ?>
